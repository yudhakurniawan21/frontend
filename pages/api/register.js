...
handler.post(async (req, res) => {
    ...
    const { email, password, job, phone, name } = req.body;
    ...
    try {
        ...
        const response = await axios.post('http://localhost:4000/register', data, { headers: { 'Content-Type': 'multipart/form-data' } });
